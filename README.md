...
Our objective is to create a customized initial setup [GitOps](https://www.ibm.com/garage/method/practices/run/gitops/) in an [`IBM Cloud`](https://cloud.ibm.com/login) environment.
